...
1. 在 [Releases](https://github.com/weiweidounai0131/skill-palette/releases/latest) 下载最新版 `Skill-Palette-1.1.1-macos.zip`。
...
1. Download `Skill-Palette-1.1.1-macos.zip` from [Releases](https://github.com/weiweidounai0131/skill-palette/releases/latest).
